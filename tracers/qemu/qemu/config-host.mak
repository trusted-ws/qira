...
libs_softmmu=-lpixman-1 -lutil  -luuid -ljpeg  
ARCH=tci
CONFIG_DEBUG_TCG=y
STRIP=strip
CONFIG_POSIX=y
...
VERSION=2.5.1
PKGVERSION=
SRC_PATH=/home/punch/qira/tracers/qemu/qemu
...
QEMU_INCLUDES=-I$(SRC_PATH)/tcg -I$(SRC_PATH)/tcg/tci -I$(SRC_PATH)/linux-headers -I/home/punch/qira/tracers/qemu/qemu/linux-headers -I. -I$(SRC_PATH) -I$(SRC_PATH)/include
AUTOCONF_HOST := 
